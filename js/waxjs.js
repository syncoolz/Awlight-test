            ...
            return t.prototype.login = function() {
                ...
                return n(this, void 0, void 0, (function() {
                    ...
                    return i(this, (function(i) {
                        ...
                        throw "READY" === t.data.type ? new Error("User started a new transaction") : new Error("Unexpected response received when attempting signing: " + JSON.stringify(t.data, void 0, 2))
                    }))
                }))
            }, t
        }();
